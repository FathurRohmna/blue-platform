...
import EcommerceApp from '@/img/service/ecommerce.svg'
import MobileApp from '@/img/service/mobileapp.svg'
import BlogApp from '@/img/service/blogapp.svg'
                  ...
                  <div className="w-full">
                    ...
                    <div className="mt-5 sm:mt-10 sm:flex justify-start">
                      <div className="rounded-md">
                        <a href="#" className="w-full flex items-center justify-center px-8 py-3 border-transparent text-base font-normal rounded-md text-white bg-blue-600">Bangun app sekarang</a>
                      </div>
                      <div className="mt-3 sm:mt-0 sm:ml-2">
                        <a href="#" className="w-full flex items-center justify-center px-8 py-3 text-base font-normal rounded-md text-blue-600 bg-white">Documentation</a>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="absolute top-32 left-1/2 my-0 w-xl">
              <div className="block w-full ml-auto">
                <div className="relative pb-80 w-full">
                  <img className="w-full h-full object-center object-cover" src={Product} />
                </div>
              </div>
            </div>
          </div>
