            ...
            <div className="relative mx-auto box-border lg:pt-32 px-0 lg:pb-28 pt-18 xl:pb-16">
              ...
              <div className="relative max-w-5xl w-4/5 mx-auto pb-16">
                <div className="w-full m-auto text-center max-w-2xl">
                  ...
                  <h1 className="text-center text-4xl sm:text-5xl md:text-6xl relative mb-9 font-bold text-gray-800">Terintregasi dengan teknologi terbaik.</h1>
                  <p className="max-w-3xl mx-auto text-center text-xl break-words whitespace-pre-line text-gray-700">Kami menggunakan teknologi-teknologi terbaru dan terbaik, yang sudah terbukti oleh banyak company.</p>
                </div>
              </div>
              ...
              <div className="relative max-w-5xl w-4/5 mx-auto pb-16">
                <div className="w-full m-auto text-center max-w-2xl">
                  <h1 className="text-center text-4xl sm:text-5xl md:text-6xl relative mb-9 font-bold text-gray-800">Frontend Teknology</h1>
                  <p className="max-w-3xl mx-auto text-center text-xl break-words whitespace-pre-line text-gray-700">Teknologi yang kami gunakan memastikan agar situs atau aplikasi anda dapat berjan dengan baik, dan mampu memberikan kesan User Experience, sehingga user dapat beriteraksi secara nyaman.</p>
                </div>
              </div>
                  ...
                  <div className="relative z-0 w-full pb-20 overflow-hidden lg:pb-0">
                    <div className="flex flex-col relative mx-auto w-10/12 max-w-7xl z-1 lg:flex-row lg:items-center lg:min-h-screen">
                      <div className="relative w-full z-1 box-border pb-11 lg:w-2/5 lg:py-52 lg:px-12 px-6">
                        <h1 className="text-xl font-semibold mt-12">Framework/Library</h1>
                        <p className="mt-4 text-lg font-normal text-gray-700"><span className="font-bold">React js</span> dan <span className="font-bold">Next js</span> sebagai tools utamanya. Untuk styling menggunakan <span className="font-bold">Tailwindcss</span>, <span className="font-bold">Material-ui</span>. Dan <span className="font-bold">Redux</span> untuk state management.</p>
                      </div>
                ...
                <div className="relative">
                  <div className="relative z-0 w-full pb-20 overflow-hidden lg:pb-0">
                    <div className="flex flex-col-reverse lg:flex-row relative mx-auto w-10/12 max-w-7xl z-1 lg:items-center lg:min-h-screen">
                      ...
                      <div className="relative w-full z-1 box-border pb-11 lg:w-2/5 lg:py-52 lg:px-12 px-6">
                        <h1 className="text-xl font-semibold mt-12">SSR/CSR/SSG</h1>
                        <p className="mt-4 text-lg font-normal text-gray-700">Menggunakan <span className="font-bold">teknologi yang tepat</span> agar produk yang di hasilkan maksimal.</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="relative w-full mx-aut
              o mb-24 mt-0 max-w-7xl lg:-mt-5">
                <div className="relative">
                  <div className="relative z-0 w-full pb-20 overflow-hidden lg:pb-0">
                    <div className="flex flex-col relative mx-auto w-10/12 max-w-7xl z-1 lg:flex-row lg:items-center lg:min-h-screen">
                      <div className="relative w-full z-1 box-border pb-11 lg:w-2/5 lg:py-52 lg:px-12 px-6">
                        <h1 className="text-xl font-semibold mt-12">Mengkonsumsi data dari Graphql atau RestAPI server</h1>
                        <p className="mt-4 text-lg font-normal text-gray-700"><span className="font-bold">Apollo/client</span> adalah tools yang digunakan kami untuk mengkonsumsi Graphql dan <span className="font-bold">Axios</span> untuk RestAPI.</p>
                      </div>
                      <div className="relative z-10 lg:w-3/5 w-full mt-10 mx-auto">
                        <div className="w-full">
                          <div className="relative w-full pb-12 h-64">
              ...
              <div className="relative max-w-5xl w-4/5 mx-auto pb-16">
                <div className="w-full m-auto text-center max-w-2xl">
                  <h1 className="text-center text-4xl sm:text-5xl md:text-6xl relative mb-9 font-bold text-gray-800">Backend Teknology</h1>
                  <p className="max-w-3xl mx-auto text-center text-xl break-words whitespace-pre-line text-gray-700">Tidak kalah penting dari sisi Client side, Server side juga sangan berperan penting dalam suatu website maupun aplikasi.</p>
                </div>
              </div>
                ...
                <div className="relative">
                  <div className="relative z-0 w-full pb-20 overflow-hidden lg:pb-0">
                    <div className="flex flex-col-reverse lg:flex-row relative mx-auto w-10/12 max-w-7xl z-1 lg:items-center lg:min-h-screen">
                      ...
                      <div className="relative w-full z-1 box-border pb-11 lg:w-2/5 lg:py-52 lg:px-12 px-6">
                        <h1 className="text-lg font-semibold mt-12">Database Management System dan ORM</h1>
                        <p className="mt-4 text-lg font-normal text-gray-700">Menggunakan <span className="font-bold">PostgreSQL</span> dan <span className="font-bold">MongoDB</span> untuk DBMS. <span className="font-bold">Prisma</span> dan <span className="font-bold">Mongoose</span> untuk ORM.</p>
                      </div>
                    </div>
                  </div>
                </div>
