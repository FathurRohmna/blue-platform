      ...
      <div className="max-w-7xl mx-auto text-xs">
        <div className="relative grid grid-cols-2 gap-8 lg:grid-cols-5 sm:grid-cols-4 pb-8 sm:pb-10 md:pb-12 lg:pb-14 text-white">
          <div className="mb-6">
            ...
            <p className="mb-2 leading-6">Bangun jaringan bisnis lebih modern dan efisien.</p>
          ...
          <div className="">
              ...
              <p className="leading-6">Karangbawang, Kawunganten <br /> Cilacap, Jawa Tengah <br /> Indonesia.</p>   
          </div>
          <div className="">
