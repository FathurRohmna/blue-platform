        ...
        <div className="relative pt-6 px-4 sm:px-6 lg:px-8">
          <nav className="relative flex items-center justify-between sm:h-10">
            <div className="flex items-center flex-grow flex-shrink-0 lg:flex-grow-0">
              <div className="flex items-center justify-between w-full md:w-auto">
                <Link href="/" className="ml-2">
                  ...
                  <img className="h-6 w-auto" src="/img/logo.svg" />
                </Link>
                <div className="mr-2 flex items-center md:hidden">
                  <Menu as="div" className="relative text-left">
                    <div>
                      <Menu.Button className="inline-flex justify-center w-full p-2">
                        <img src="/img/menu.svg" className="w-5 h-5" />
                      </Menu.Button>
                    </div>
                    <Transition
                      as={Fragment}
            ...
            <div className="hidden md:block md:ml-10 md:pr-4 md:space-x-8">
              <Link
                href="/product"
                className="font-semibold text-lg text-gray-700 hover:text-gray-500"
              >
                Product
              </Link>
              ...
              <Link
                href="/order"
                className="font-medium text-base rounded-md  text-white px-8 py-3 border-transparent hover:bg-blue-700 bg-blue-600 md:py-4 md:text-lg md:px-10"
              >
                Pesan App
              </Link>
            </div>
